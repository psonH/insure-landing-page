...
const Features = () => {
  return (
    <div className="features-container">
      {/*<hr className="hr-custom-light" />*/}
      <div className="features-title">We're different</div>
      <Row className="features">
        <Col sm={12} md={6} lg={4}>
          <Card className="feature-card">
            ...
            <Card.Body>
              <Card.Title className="features-heading">
                Snappy Process
              </Card.Title>
              <Card.Text className="heading-body">
        ...
        <Col sm={12} md={6} lg={4}>
          <Card className="feature-card">
            ...
            <Card.Body>
              <Card.Title className="features-heading">People First</Card.Title>
              <Card.Text className="heading-body">
